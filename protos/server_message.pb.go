...
func file_server_message_proto_init() {
	...
	file_server_message_proto_msgTypes[7].OneofWrappers = []any{}
	file_server_message_proto_msgTypes[11].OneofWrappers = []any{}
	file_server_message_proto_msgTypes[15].OneofWrappers = []any{}
